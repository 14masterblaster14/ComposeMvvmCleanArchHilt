package com.example.composemvvmcleanarchhilt.compose.converter
...
fun ConversionMenu(
    ...
    var displayingText by rememberSaveable { mutableStateOf("Select the conversion type") } // Default Text
